...
<h1 class="text-2xl font-extrabold mb-4 text-gray-700" style="font-family: 'Arial Black', Arial, sans-serif;">
  ...
  <div class="bg-white border-l-4 border-[#00001A] p-4 rounded-md shadow-sm text-gray-600 text-[15px] font-[Poppins] leading-relaxed max-w-full">
    <strong class="text-blue-600">Why Use KodigoUI Input Components?</strong><br>
    KodigoUI input fields are more than just form controls — they're enhanced with built-in validation support, Livewire reactivity, and accessible markup. Here’s what makes them valuable:
    <ul class="list-disc pl-5 mt-2 space-y-1">
      <li><strong>Built-in Error Handling:</strong> Automatically displays validation messages below each input when integrated with Livewire or Laravel form requests.</li>
      <li><strong>Consistent Spacing & Sizing:</strong> Standardized padding, font sizes, and spacing across all input sizes ensure visual consistency.</li>
      <li><strong>Livewire-Ready:</strong> Bind directly to Livewire properties and take advantage of real-time form updates and error responses.</li>
      <li><strong>Fully Customizable:</strong> Easily override styles using Tailwind classes or extend with icons, addons, and tooltips.</li>
      <li><strong>Accessibility Focused:</strong> Labeled, keyboard-friendly, and ARIA-ready out of the box.</li>
    </ul>
  </div>
            ...
            <div class="space-y-4 mt-6"> 
                <h2 class="text-lg font-semibold text-gray-700">Input Text</h2>
                ...
                <div x-data="{ showCode: false }" class="p-4 border rounded-lg shadow-sm bg-[#000034] relative">
                    ...
                    <div class="mt-4 flex flex-col gap-2">
                        <x-input-text size="short" placeholder="Enter name" />
                        <x-input-text size="standard" placeholder="Enter name" />
                        <x-input-text size="long" placeholder="Enter name" />
                    </div>
